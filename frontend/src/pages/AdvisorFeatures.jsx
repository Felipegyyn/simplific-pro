...
import { 
  Wallet, Calendar, TrendingUp, MessageCircle, 
      ...
      <div className="flex-grow container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="text-center mb-16 mt-8">
          ...
          <p className="text-xl text-gray-500 max-w-3xl mx-auto leading-relaxed">
            ...
            Tudo isso conversando naturalmente, por áudio ou texto.
          </p>
        </div>
        ...
        <div className="bg-gray-900 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-white mb-6">Fale naturalmente 🗣️</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6 text-left">
              <div className="bg-gray-800/50 p-4 rounded-xl border border-gray-700">
                ...
                <p className="text-gray-400 line-through">"Cadastrar despesa valor 50 categoria alimentação"</p>
              </div>
              <div className="bg-green-900/30 p-4 rounded-xl border border-green-500/30">
                ...
                <p className="text-white">"Cara, acabei de comer um burguer de 50 reais. Anota aí pra mim!"</p>
              </div>
            </div>

            <div className="mt-10 flex flex-col md:flex-row justify-center items-center gap-6 text-sm text-gray-400">
