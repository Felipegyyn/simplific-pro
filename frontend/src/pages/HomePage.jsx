            ...
            <div className="dia2-palco">
                <div className="dia2-quadro" id="dia2Quadro" aria-hidden="true">
                    <div className="dia2-cena is-ativa" data-ato="1">
                        ...
                        <div className="dia-arte" style={{DiaArte: 'url(\'images/7-40.webp\')'}} aria-hidden="true"></div>
                    ...
                    <div className="dia2-cena" data-ato="2">
                        ...
                        <div className="dia-arte" style={{DiaArte: 'url(\'images/9-15.webp\')'}} aria-hidden="true"></div>
                    ...
                    <div className="dia2-cena" data-ato="3">
                        ...
                        <div className="dia-arte" style={{DiaArte: 'url(\'images/12-30.webp\')'}} aria-hidden="true"></div>
                        <div className="dia-noti">
                    ...
                    <div className="dia2-cena" data-ato="4">
                        ...
                        <div className="dia-arte" style={{DiaArte: 'url(\'images/15-30.webp\')'}} aria-hidden="true"></div>
                    ...
                    <div className="dia2-cena" data-ato="5">
                        ...
                        <div className="dia-arte" style={{DiaArte: 'url(\'images/22-00.webp\')'}} aria-hidden="true"></div>
                ...
                <div className="gd-viewport">
                    ...
                    <article className="gd-tela gd-tela--fluxo is-vez">
                        ...
                        <div className="gd-kpis">
                            <div className="gd-w gd-kpi" style={{GdI: '0'}}>
                            ...
                            <div className="gd-w gd-kpi" style={{GdI: '1'}}>
                                <div className="gd-whead">
                                    <span className="gd-alca"><i></i><i></i><i></i><i></i><i></i><i></i></span>
                                    <span className="gd-wtxt">
                            ...
                            <div className="gd-w gd-kpi gd-kpi--forte" style={{GdI: '2'}}>
                                <div className="gd-whead">
                                    <span className="gd-alca"><i></i><i></i><i></i><i></i><i></i><i></i></span>
                                    <span className="gd-wtxt">
                        ...
                        <div className="gd-w gd-carta gd-carta--fluxo" style={{GdI: '3'}}>
                            <div className="gd-whead">
                                <span className="gd-alca"><i></i><i></i><i></i><i></i><i></i><i></i></span>
                                <span className="gd-wtxt">
                            ...
                            <div className="gd-graf">
                                ...
                                <div className="gd-plot">
                                    ...
                                    <div className="gd-barras gd-barras--par">
                                        <div className="gd-bgrupo" style={{GdN: '0'}}>
                                            <span className="gd-bar gd-bar--azul" style={{GdH: '56%'}}></span>
                                            <span className="gd-bar gd-bar--menta" style={{GdH: '54.5%'}}></span>
                                        </div>
                                        <div className="gd-bgrupo" style={{GdN: '1'}}>
                                            <span className="gd-bar gd-bar--azul" style={{GdH: '69.5%'}}></span>
                                            <span className="gd-bar gd-bar--menta" style={{GdH: '58.5%'}}></span>
                                        </div>
                                        <div className="gd-bgrupo" style={{GdN: '2'}}>
                                            <span className="gd-bar gd-bar--azul" style={{GdH: '65.5%'}}></span>
                                            <span className="gd-bar gd-bar--menta" style={{GdH: '62%'}}></span>
                                        </div>
                                        <div className="gd-bgrupo" style={{GdN: '3'}}>
                                            <span className="gd-bar gd-bar--azul" style={{GdH: '78%'}}></span>
                                            <span className="gd-bar gd-bar--menta" style={{GdH: '60.5%'}}></span>
                                        </div>
                                        <div className="gd-bgrupo" style={{GdN: '4'}}>
                                            <span className="gd-bar gd-bar--azul" style={{GdH: '84%'}}></span>
                                            <span className="gd-bar gd-bar--menta" style={{GdH: '67.5%'}}></span>
                                        </div>
                                        <div className="gd-bgrupo" style={{GdN: '5'}}>
                                            <span className="gd-bar gd-bar--azul" style={{GdH: '91.2%'}}></span>
                                            <span className="gd-bar gd-bar--menta" style={{GdH: '69.65%'}}></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <article className="gd-tela gd-tela--gastos">
                        ...
                        <div className="gd-duas">
                            <div className="gd-w gd-carta gd-carta--donut" style={{GdI: '1'}}>
                                <div className="gd-whead">
                                    <span className="gd-alca"><i></i><i></i><i></i><i></i><i></i><i></i></span>
                                    <span className="gd-wtxt">
                                ...
                                <div className="gd-donut">
                                    <svg viewBox="0 0 120 120" aria-hidden="true" focusable="false">
                                        ...
                                        <circle className="gd-fatia gd-fatia--1" style={{GdLen: '81.83', GdDur: '322ms', GdOff: '0ms'}} cx="60" cy="60" r="42" transform="rotate(-90 60 60)" stroke-dasharray="81.83 264"/>
                                        <circle className="gd-fatia gd-fatia--2" style={{GdLen: '66.85', GdDur: '263ms', GdOff: '322ms'}} cx="60" cy="60" r="42" transform="rotate(24.36 60 60)" stroke-dasharray="66.85 264"/>
                                        <circle className="gd-fatia gd-fatia--3" style={{GdLen: '48.95', GdDur: '193ms', GdOff: '585ms'}} cx="60" cy="60" r="42" transform="rotate(118.29 60 60)" stroke-dasharray="48.95 264"/>
                                        <circle className="gd-fatia gd-fatia--4" style={{GdLen: '34.34', GdDur: '135ms', GdOff: '778ms'}} cx="60" cy="60" r="42" transform="rotate(187.80 60 60)" stroke-dasharray="34.34 264"/>
                                        <circle className="gd-fatia gd-fatia--5" style={{GdLen: '21.92', GdDur: '87ms', GdOff: '913ms'}} cx="60" cy="60" r="42" transform="rotate(237.37 60 60)" stroke-dasharray="21.92 264"/>
                                    </svg>
                            ...
                            <div className="gd-coluna">
                                <div className="gd-w gd-kpi gd-kpi--forte" style={{GdI: '0'}}>
                                    <div className="gd-whead">
                                        <span className="gd-alca"><i></i><i></i><i></i><i></i><i></i><i></i></span>
                                        <span className="gd-wtxt">
                            ...
                            <div className="gd-w gd-carta gd-carta--lista" style={{GdI: '2'}}>
                                <div className="gd-whead">
                                    <span className="gd-alca"><i></i><i></i><i></i><i></i><i></i><i></i></span>
                                    <span className="gd-wtxt">
                                ...
                                <ul className="gd-lista">
                                    <li className="gd-item" style={{GdN: '0'}}><i className="gd-marca gd-marca--1"></i><span className="gd-item-nome">Mercado</span><span className="gd-item-fat">32,2%</span><span className="gd-item-val">R$ 2.240</span></li>
                                    <li className="gd-item" style={{GdN: '1'}}><i className="gd-marca gd-marca--2"></i><span className="gd-item-nome">Casa</span><span className="gd-item-fat">26,3%</span><span className="gd-item-val">R$ 1.830</span></li>
                                    <li className="gd-item" style={{GdN: '2'}}><i className="gd-marca gd-marca--3"></i><span className="gd-item-nome">Restaurantes</span><span className="gd-item-fat">19,3%</span><span className="gd-item-val">R$ 1.340</span></li>
                                    <li className="gd-item" style={{GdN: '3'}}><i className="gd-marca gd-marca--4"></i><span className="gd-item-nome">Transporte</span><span className="gd-item-fat">13,5%</span><span className="gd-item-val">R$ 940</span></li>
                                    <li className="gd-item" style={{GdN: '4'}}><i className="gd-marca gd-marca--5"></i><span className="gd-item-nome">Outros</span><span className="gd-item-fat">8,7%</span><span className="gd-item-val">R$ 600</span></li>
                                </ul>
                            </div>
                            </div>
                        </div>
                    ...
                    <article className="gd-tela gd-tela--transf">
                        ...
                        <div className="gd-w gd-carta gd-carta--barras" style={{GdI: '0'}}>
                            <div className="gd-whead">
                                <span className="gd-alca"><i></i><i></i><i></i><i></i><i></i><i></i></span>
                                <span className="gd-wtxt">
                            ...
                            <div className="gd-graf">
                                ...
                                <div className="gd-plot">
                                    ...
                                    <div className="gd-barras gd-barras--sete">
                                        <div className="gd-bcol" style={{GdN: '0'}}><span className="gd-coroa">85</span><span className="gd-bar gd-bar--menta" style={{GdH: '29.75%'}}></span></div>
                                        <div className="gd-bcol" style={{GdN: '1'}}><span className="gd-coroa">40</span><span className="gd-bar gd-bar--menta" style={{GdH: '14%'}}></span></div>
                                        <div className="gd-bcol" style={{GdN: '2'}}><span className="gd-coroa">160</span><span className="gd-bar gd-bar--menta" style={{GdH: '56%'}}></span></div>
                                        <div className="gd-bcol" style={{GdN: '3'}}><span className="gd-coroa">75</span><span className="gd-bar gd-bar--menta" style={{GdH: '26.25%'}}></span></div>
                                        <div className="gd-bcol" style={{GdN: '4'}}><span className="gd-coroa">220</span><span className="gd-bar gd-bar--menta" style={{GdH: '77%'}}></span></div>
                                        <div className="gd-bcol" style={{GdN: '5'}}><span className="gd-coroa">130</span><span className="gd-bar gd-bar--menta" style={{GdH: '45.5%'}}></span></div>
                                        <div className="gd-bcol" style={{GdN: '6'}}><span className="gd-coroa">55</span><span className="gd-bar gd-bar--menta" style={{GdH: '19.25%'}}></span></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="gd-kpis gd-kpis--dois">
                            <div className="gd-w gd-kpi gd-kpi--forte" style={{GdI: '1'}}>
                                <div className="gd-whead">
                                    <span className="gd-alca"><i></i><i></i><i></i><i></i><i></i><i></i></span>
                                    <span className="gd-wtxt">
                            ...
                            <div className="gd-w gd-kpi" style={{GdI: '2'}}>
                                <div className="gd-whead">
                                    <span className="gd-alca"><i></i><i></i><i></i><i></i><i></i><i></i></span>
                                    <span className="gd-wtxt">
        ...
        <div className="footer-inner">
            <div className="footer-top">
                ...
                <div className="footer-col footer-support" aria-labelledby="footerColSuporte">
                    ...
                    <a href="mailto:contato@meuassessor.com" className="footer-mail">contato@meuassessor.com</a>
