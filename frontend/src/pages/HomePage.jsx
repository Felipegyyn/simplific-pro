...
const HomePage = () => {
  ...
  return (
      ...
      <header className="relative pt-24 pb-40 overflow-hidden">
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-16 items-center relative z-10">
          <div className="space-y-10 relative">
            ...
            {/* Badge de Urgência Piscante - ATUALIZADO */}
            <div className="inline-flex items-center gap-2 bg-green-500 text-black px-6 py-2 transform -skew-x-12 font-black tracking-wider uppercase text-sm shadow-[0_0_20px_rgba(34,197,94,0.6)] animate-pulse">
               <Star size={18} fill="black" /> Oferta Especial Liberada
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-xl border-l-8 border-green-500 pl-6 font-medium leading-relaxed">
              Tenha <strong>uma plataforma profissional para chamar de SUA e um Assessor Financeiro com IA 24 horas por dia</strong> no WhatsApp pelo preço de um café.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 pt-6">
              ...
              >
                COMEÇAR AGORA <Zap fill="black" className="ml-2 animate-bounce" />
              </Button>
          ...
          <div className="relative hidden md:block group perspective-1000">
            ...
            <div className="relative bg-black border-2 border-green-500/50 rounded-[30px] p-3 shadow-[0_0_50px_rgba(34,197,94,0.2)] group-hover:shadow-[0_0_100px_rgba(34,197,94,0.5)] transform transition-all duration-500 group-hover:scale-[1.02] overflow-hidden">
               {/* Faixa de Destaque na Imagem - ATUALIZADO */}
               <div className="absolute top-5 right-0 bg-green-500 text-black font-black text-sm px-6 py-2 transform skew-x-12 z-20 shadow-lg uppercase">
                   Módulo IA Liberado
               </div>
    ...
    {/* --- FAIXA DE URGÊNCIA (Hazard Style - VERSÃO ATUALIZADA) --- */}
      <div className="relative z-20 py-10 overflow-visible"> 
        
        {/* CAMADA DE FUNDO INCLINADA - Mudado para Verde Neon/Amarelo para manter destaque mas sem ser "Black Friday" */}
        ...
        <div className="container mx-auto px-4 relative z-10 flex justify-between items-center font-black uppercase tracking-[0.2em] text-sm md:text-lg animate-pulse text-black">
            <span className="flex items-center gap-3 min-w-fit">
              <Flame size={26} fill="black"/> OFERTA LIMITADA
            </span>
            
            {/* Bloco Central Preto */}
            <div className="hidden md:block relative mx-4">
              <div className="absolute inset-0 bg-black transform -skew-x-12 shadow-2xl"></div>
              <span className="relative z-10 text-yellow-400 px-10 py-3 block"> 
                  A MELHOR OPORTUNIDADE DO ANO
              </span>
            </div>
            
            <span className="flex items-center gap-3 min-w-fit">
              NÃO PERCA ESSA CHANCE <Flame size={26} fill="black"/>
            </span>
        </div>
      </div>
      ...
      <section id="oferta" className="py-32 relative overflow-hidden bg-black">
        ...
        <div className="container mx-auto px-4 max-w-5xl relative z-10">
          ...
          <div className="text-center mb-16">
            <span className="inline-block bg-green-600 text-black font-black tracking-widest uppercase px-4 py-1 mb-4 text-sm transform -skew-x-12 animate-pulse">
                ⚡ Plano de Aceleração Financeira
            </span>
      ...
      <section className="py-32 bg-black relative z-10 border-t-2 border-green-900/50">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-4xl font-black text-center mb-16 text-white uppercase tracking-tight">Perguntas Frequentes</h2>
          <div className="space-y-4 bg-gray-900/50 p-8 border border-gray-800">
            <FaqItem question="O PREÇO PROMOCIONAL É VITALÍCIO?" answer="Ao garantir o plano ANUAL hoje, você trava esse valor pelos próximos 12 meses. É a melhor decisão financeira para começar o ano com o pé direito." />
