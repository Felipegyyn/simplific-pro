...
function PhoneMockup() {
  return (
    <div className="relative mx-auto w-full max-w-[760px] overflow-hidden rounded-[32px] border border-white/10 bg-[#0b0c0b] shadow-[0_30px_90px_rgba(0,0,0,.55)]">
      <div className="absolute inset-0 bg-lime-300/[.05] blur-3xl" />
      <img src="/assets/landing/simplific-hero.jpg" alt="Demonstração visual do Simplific" className="relative z-10 h-auto w-full object-cover" />
      <div className="absolute bottom-5 left-5 right-5 z-20 flex items-center justify-between rounded-2xl border border-white/15 bg-[#0b0c0b]/85 px-4 py-3 text-xs text-white/60 backdrop-blur-xl sm:left-8 sm:right-8">
        <span className="flex items-center gap-2"><Sparkles size={14} className="text-lime-300" /> Seu dinheiro, organizado em uma conversa</span><ArrowRight size={15} className="text-lime-300" />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="simplific-landing min-h-screen overflow-x-hidden bg-[#080908] font-sans text-white selection:bg-lime-300 selection:text-black">
      ...
      <main>
        ...
        <section className="border-y border-white/10 bg-[#0b0c0b] py-24 md:py-32"><div className="container mx-auto max-w-7xl px-5 md:px-10"><div className="mx-auto mb-14 max-w-2xl text-center"><span className="text-xs font-semibold uppercase tracking-[.22em] text-lime-300">Uma equipe para cada parte da sua rotina</span><h2 className="mt-4 text-4xl font-semibold tracking-[-.04em] md:text-5xl">Pare de tentar organizar tudo sozinho.</h2><p className="mt-5 text-white/45">Os assessores do Simplific trabalham juntos para transformar mensagens em coisas resolvidas.</p></div><div className="grid gap-4 md:grid-cols-3"><div className="group overflow-hidden rounded-3xl border border-white/10 bg-[#101210]"><img src="/assets/landing/simplific-assessor-financeiro.jpg" alt="Assessor financeiro do Simplific" className="h-72 w-full object-cover object-top grayscale transition-all duration-500 group-hover:grayscale-0" /><div className="p-6"><span className="text-xs uppercase tracking-[.18em] text-lime-300">Finanças</span><h3 className="mt-2 text-2xl font-medium">Nexo</h3><p className="mt-3 text-sm leading-6 text-white/45">Organiza gastos, acompanha cartões e mostra os padrões do seu dinheiro.</p></div></div><div className="group overflow-hidden rounded-3xl border border-white/10 bg-[#101210]"><img src="/assets/landing/simplific-assessor-agenda.jpg" alt="Assessora de agenda do Simplific" className="h-72 w-full object-cover object-top grayscale transition-all duration-500 group-hover:grayscale-0" /><div className="p-6"><span className="text-xs uppercase tracking-[.18em] text-lime-300">Agenda</span><h3 className="mt-2 text-2xl font-medium">Clara</h3><p className="mt-3 text-sm leading-6 text-white/45">Cuida de lembretes, compromissos e prioridades sem você precisar abrir outro app.</p></div></div><div className="group overflow-hidden rounded-3xl border border-white/10 bg-[#101210]"><img src="/assets/landing/simplific-assessor-documentos.jpg" alt="Assessor de documentos do Simplific" className="h-72 w-full object-cover object-top grayscale transition-all duration-500 group-hover:grayscale-0" /><div className="p-6"><span className="text-xs uppercase tracking-[.18em] text-lime-300">Organização</span><h3 className="mt-2 text-2xl font-medium">Atlas</h3><p className="mt-3 text-sm leading-6 text-white/45">Encontra comprovantes, lê documentos e deixa tudo acessível quando você precisa.</p></div></div></div></div></section>
