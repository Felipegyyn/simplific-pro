...
const HomePage = () => {
  ...
  const MONTHLY_CHECKOUT_LINK = "SEU_LINK_MENSAL_AQUI"; // (Fallback apenas)
  const ANNUAL_CHECKOUT_LINK = "#"; 
      ...
      <header className="relative overflow-hidden bg-gradient-to-br from-green-900 to-green-700 text-white pt-20 pb-32">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="inline-block bg-green-500/20 text-green-100 px-3 py-1 rounded-full text-sm font-semibold">🚀 Lançamento Especial</div>
            <h1 className="text-4xl md:text-6xl font-bold leading-tight">Cansado da desordem financeira?</h1>
            <p className="text-lg md:text-xl text-green-100 opacity-90 max-w-lg">Assuma o controle e alcance a tão sonhada liberdade. O aplicativo completo que organiza suas finanças, planeja metas e te acompanha até no WhatsApp.</p>
            
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              {/* BOTÃO 1: Link direto para Checkout */}
              <Button 
              ...
              {/* BOTÃO 2: "Já sou cliente" CORRIGIDO */}
              <Button 
                onClick={() => navigate('/login')} 
                variant="outline" 
                className="h-14 px-8 rounded-xl bg-transparent border-2 border-white text-white hover:bg-white hover:text-green-900 transition-colors"
              >
                Já sou cliente
              </Button>
            </div>
            
            <p className="text-sm text-green-200 flex items-center gap-2"><ShieldCheck size={16} /> 7 dias de garantia incondicional</p>
          </div>
          ...
          <div className="relative hidden md:block">
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-2 shadow-2xl transform rotate-2 hover:rotate-0 transition-all duration-500">
               <img src="/assets/image_745581.png" alt="Dashboard Simplific Pro" className="rounded-xl w-full h-auto shadow-inner" />
            </div>
          </div>
        </div>
      ...
      <section id="beneficios" className="py-20 bg-white">
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-3 gap-8">
          ...
          <div className="p-8 rounded-2xl bg-gray-50 hover:bg-green-50 transition-colors border border-gray-100 hover:border-green-200 group">
            ...
            <p className="text-gray-600 leading-relaxed">Visualize toda sua situação financeira em uma tela.</p>
          </div>
           <div className="p-8 rounded-2xl bg-gray-50 hover:bg-green-50 transition-colors border border-gray-100 hover:border-green-200 group">
           ...
           <div className="p-8 rounded-2xl bg-gray-50 hover:bg-green-50 transition-colors border border-gray-100 hover:border-green-200 group">
            ...
            <p className="text-gray-600 leading-relaxed">Acompanhe fluxo de caixa, investimentos e cartões de crédito.</p>
          </div>
           <div className="p-8 rounded-2xl bg-gray-50 hover:bg-green-50 transition-colors border border-gray-100 hover:border-green-200 group">
          ...
          <div className="p-8 rounded-2xl bg-gray-50 hover:bg-green-50 transition-colors border border-gray-100 hover:border-green-200 group">
           ...
           <div className="p-8 rounded-2xl bg-gray-50 hover:bg-green-50 transition-colors border border-gray-100 hover:border-green-200 group">
            ...
            <p className="text-gray-600 leading-relaxed">Transforme seus maiores sonhos em planos concretos.</p>
          </div>
          <div className="p-8 rounded-2xl bg-gray-50 hover:bg-green-50 transition-colors border border-gray-100 hover:border-green-200 group">
            ...
            <p className="text-gray-600 leading-relaxed">Tenha acesso ao chat inteligência Simplific na própria plataforma.</p>
          </div>
        </div>
      </section>
      ...
      <section id="ia" className="py-20 bg-green-600 text-white overflow-hidden">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2 space-y-6">
            ...
            <Button 
                onClick={() => navigate('/checkout')} 
                className="bg-white text-green-700 hover:bg-gray-100 font-bold text-lg mt-4 px-8 py-6 h-auto rounded-xl shadow-lg w-full sm:w-auto"
            >
