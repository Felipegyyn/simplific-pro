...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-black font-sans text-gray-100 selection:bg-green-500 selection:text-black overflow-x-hidden">
      ...
      {/* --- HERO SECTION --- */}
      {/* Ajustado padding top para mobile não colar no menu */}
      <header className="relative pt-32 pb-32 md:pt-24 md:pb-40 overflow-hidden">
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center relative z-10">
          ...
          {/* BLOCO DE TEXTO */}
          {/* Mantido alinhamento à esquerda padrão */}
          <div className="space-y-8 md:space-y-10 relative">
            ...
            {/* Fonte ajustada para mobile: text-4xl */}
            ...
            {/* Botões: Stack vertical no mobile (flex-col), lado a lado no desktop (sm:flex-row) */}
          ...
          <div className="relative pt-12 md:pt-0 flex justify-center items-center">
             ...
             {/* Grupo Wrapper: 
                 - scale-[0.6]: Reduzi para 60% no mobile. Isso GARANTE que cabe na tela.
                 - origin-center: Cresce do meio
                 - Sem translates laterais no mobile para evitar overflow
             */}
             <div className="relative transform scale-[0.60] sm:scale-[0.80] md:scale-100 lg:scale-110 transition-transform duration-700 origin-center">
                ...
                {/* 2. O CELULAR */}
                <div className="absolute bottom-0 right-0 z-20 transform translate-x-[15%] translate-y-[5%]">
