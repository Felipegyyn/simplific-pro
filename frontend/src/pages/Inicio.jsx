    ...
    <div className="p-4 sm:p-6 space-y-6 bg-gray-50 dark:bg-slate-900 min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="col-span-1 flex flex-col gap-6">
          ...
          <Card className="border-border shadow-sm flex flex-col h-[605px] overflow-hidden">
          ...
          <Card className="border-border shadow-sm flex flex-col flex-1 min-h-[300px] overflow-hidden">
            {/* ▼▼▼ CABEÇALHO VERDE ESCURO ▼▼▼ */}
